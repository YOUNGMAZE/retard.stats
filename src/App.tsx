...
export default function App() {
  ...
  const [isMapsSectionOpen, setIsMapsSectionOpen] = useState<Record<string, boolean>>({});
  ...
  const toggleMapsSection = useCallback((playerId: string) => {
    setIsMapsSectionOpen((previous) => ({
      ...previous,
                ...
                >
                  ...
                  <div className="mt-4 text-sm text-zinc-300">
                    <div className="mb-2 flex items-center justify-between gap-3">
                      <p className="text-zinc-400">Матчи по картам</p>
                      <button
                        type="button"
                          ...
                          <div className="w-[132px] justify-self-center">
                            ...
                            >
                              <span className="relative block aspect-[250/82] w-full overflow-hidden rounded-md bg-zinc-900">
                                ...
                                />
                                <span
                                  className={`absolute inset-0 flex items-center justify-end bg-black/30 pl-3 text-right text-base font-black uppercase tracking-wide text-zinc-100 ${
